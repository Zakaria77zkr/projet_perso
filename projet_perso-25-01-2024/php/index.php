    ...
    <main class="accueil_main">
        ...
        <div class="accueil_carousel">
            <ul>
                ...
                <!-- <li><img src="ressources/caroussel_accueil/5.webp" alt=""></li>
                <li><img src="ressources/caroussel_accueil/6.webp" alt=""></li>
                <li><img src="ressources/caroussel_accueil/7.webp" alt=""></li> -->
