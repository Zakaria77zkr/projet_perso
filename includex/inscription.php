...
include_once "assets/js/fonction.js";
?>
<div class="inscription_container hidden">
    <div class="inscription_div">
        <section class="inscription_section">
            ...
            <!-- Formulaire -->
            <form action="includex\traitement_inscri.php" method="post" class="inscription_form" onsubmit="return confirm_pass()">
                ...
                <div class="inscription_emailmdp">
                    ...
                    <input type="password" id="password" name="password" placeholder="Mot de passe" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*\W)(?!.*\s).{8,}">
                    <p class="connectError"></p>
                    <input type="password" id="confirm-password" placeholder="Confirmation du mot de passe*" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*\W)(?!.*\s).{8,}">
